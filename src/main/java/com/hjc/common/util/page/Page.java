...
// 		sb.append("</ul>");
 		...
 		if (pageNum == first) {// 如果是首页
 			sb.append("<li class=\"paginate_button previous disabled\"><a href=\"javascript:\"><i class=\" icon-double-angle-left\"></i></a></li>\n");
 			sb.append("<li class=\"paginate_button previous disabled\"><a href=\"javascript:\"><i class=\"icon-angle-left\"></i></a></li>\n");
 		} else {
 			sb.append("<li class=\"paginate_button previous\"><a href=\"javascript:\" onclick=\""+funcName+"("+first+","+pageSize+");\"><i class=\" icon-double-angle-left\"></i></a></li>\n");
 			sb.append("<li class=\"paginate_button previous\"><a href=\"javascript:\" onclick=\""+funcName+"("+getPrev()+","+pageSize+");\"><i class=\"icon-angle-left\"></i></a></li>\n");
 		}
 		...
 		if (pageNum == pages || total == 0) {
 			sb.append("<li class=\"paginate_button next disabled\"><a href=\"javascript:\"><i class=\"icon-angle-right\"></i></a></li>\n");
 			sb.append("<li class=\"paginate_button next disabled\"><a href=\"javascript:\"><i class=\" icon-double-angle-right\"></i></a></li>\n");
 		} else {
