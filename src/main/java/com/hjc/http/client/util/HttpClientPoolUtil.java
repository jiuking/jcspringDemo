 ...
 * @date : 2018/7/12 0012 15:53
 * @description : HttpClient线程池
 */
        ...
        try {
            ...
            if (httpEntity != null) {
                try {
                    ...
                    e.printStackTrace();
                    logger.error("close response exception, url:{}, exception:{}, cost time(ms):{}", uri, e.toString(), (System.currentTimeMillis() - startTime));
                }
            }
        }
        return responseBody;
